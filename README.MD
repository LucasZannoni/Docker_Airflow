...
Após isso, o texto à esquerda do seu comando deve mudar, indicando que você está agora no prompt de comando do sistema ubuntu.

Agora, execute o seguinte comando para criar seu usuário e senha:
